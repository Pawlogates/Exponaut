...
const info_MAIN_1 = ["Training Tunnel", 0, -460, 40, 180000, 60, "Pawlogates", "beginner"]
const info_MAIN_2 = ["Valley of Vigor", 2, -360, 80, 75000, 60, "Pawlogates", "beginner"]
const info_MAIN_3 = ["Toggle Land", 1, 280, 60, 250000, 60, "Pawlogates", "beginner"]
const info_MAIN_4 = ["Carrots and Sticks", 1, 180, 40, 80000, 60, "Pawlogates", "beginner"]
const info_MAIN_5 = ["Chilling Exercise", 1, -120, -100, 4000, 60, "Pawlogates", "beginner"]
const info_MAIN_6 = ["Daring Dash", 1, 700, 80, 25000, 60, "Pawlogates", "beginner"]
const info_MAIN_7 = ["Puzzlin' Around", 1, 200, -40, 15000, 60, "Pawlogates", "intermediate"]
const info_MAIN_8 = ["Puzzlin' Around", 1, 200, -40, 15000, 60, "Pawlogates", "intermediate"]
const info_MAIN_9 = ["Puzzlin' Around", 1, 200, -40, 15000, 60, "Pawlogates"]
const info_MAIN_10 = ["Puzzlin' Around", 1, 200, -40, 15000, 60, "Pawlogates"]
...
const info_BONUS_1 = ["Unnamed", 1, 100000, 60]
const info_BONUS_2 = ["Unnamed", 1, 100000, 60]
const info_BONUS_3 = ["Unnamed", 1, 100000, 60]
const info_BONUS_4 = ["Unnamed", 1, 100000, 60]
const info_BONUS_5 = ["Unnamed", 1, 100000, 60]
const info_BONUS_6 = ["Unnamed", 1, 100000, 60]
const info_BONUS_7 = ["Unnamed", 1, 100000, 60]

# Debug Levels.
const info_DEBUG_1 = ["test_collectibles", 1, -400, 64, -1, -1]
const info_DEBUG_2 = ["test_physics_objects", 1, -350, 64, -1, -1]
const info_DEBUG_3 = ["test_zones", 1, -300, 64, -1, -1]
const info_DEBUG_4 = ["test_random_objects", 1, -250, 64, -1, -1]
const info_DEBUG_5 = ["test_weapons", 1, -200, 64, -1, -1]
const info_DEBUG_6 = ["test_switches", 1, -150, 64, -1, -1]
const info_DEBUG_7 = ["test_random_enemy", 1, -100, 64, -1, -1]
const info_DEBUG_8 = ["test_lethalBall", 1, -50, 64, -1, -1]
const info_DEBUG_9 = ["test_meme_mode", 1, 0, 64, -1, -1]
const info_DEBUG_10 = ["test_object_saved_state", 1, 50, 64, -1, -1]
const info_DEBUG_11 = ["test_random_decoration", 1, 100, 64, -1, -1]
const info_DEBUG_12 = ["area_factory", 2, 0, 0, -1, -1]
const info_DEBUG_13 = ["area_infected_glades", 2, 0, 0, -1, -1]
const info_DEBUG_14 = ["area_glades", 2, 0, 0, -1, -1]
const info_DEBUG_15 = ["area_castle", 2, 0, 0, -1, -1]
const info_DEBUG_16 = ["area_ascent", 2, 0, 0, -1, -1]
