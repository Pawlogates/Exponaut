...
var list_effect_name : Array = ["general/rotate_away_up_right", "general/rotate_away_up_right_scale_up", "general/rotate_around_y_fade_out", "general/reflect_straight", "general/fade_out_up"]
